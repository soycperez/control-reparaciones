...
<body>
    <header>
        ...
        <nav>
            <ul>
                <li><a href="./Navegacion/historial-trabajador.php">Consular Historial</a></li>
    ...
    <section>
        ...
        <table class="table table-striped">
            ...
            $equiposEnReparacion = $consultasEmpleado->obtenerReparacionesActuales($idEmpleado, $coneccion);
            ...
            ?>
                    <tr>
                        ...
                        <td>
                        <button type="submit" class="btn btn-warning"><b><a class="btnEditar" href="./Consultas/peticiones.php?idEquipo=<?php echo $reparacion["idEquipo"] ?>">Cambiar Estado</a></b></button>
                        </td>
                    </tr>
            <?php
                }
